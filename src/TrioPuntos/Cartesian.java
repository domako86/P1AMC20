...
/*  int xLength = (X_AXIS_SECOND_X_COORD - X_AXIS_FIRST_X_COORD)
    ...
    public void drawPointOnPanel(Point point, Graphics g) {
        final int pointDiameter = 5;
        final int x = X_AXIS_FIRST_X_COORD + (point.getX() * xLength) - pointDiameter / 2;
        final int y = Y_AXIS_SECOND_Y_COORD - (point.getY()* yLength) - pointDiameter / 2;
